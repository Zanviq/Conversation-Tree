...
import { Plus, MessageSquare, Menu, X, GitGraph } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const handleEditAndForkNode = (aiNodeId: string, newText: string) => {
    ...
    appendAndStream(activeSession.id, parentId, newText);
  };
    ...
    <div className="flex h-[100dvh] w-full bg-space-950 text-gray-200 overflow-hidden font-sans relative">
      ...
      <div className="flex-1 flex flex-col relative min-w-0 h-full">
        ...
        <ChatInterface 
          ...
          messageMap={activeSession?.messageMap} // PASSING MAP HERE
      ...
      {/* Track View Modal - Elevated to App level for Z-Index management (above Map) */}
      {viewingTrack && (
        <div 
